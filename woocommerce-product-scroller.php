...
<div class="wrap ms-toggle">
  ...
  <table width="50%" class="widefat">
        ...
        <tr>
          <th style="width: 100px;" colspan="2"><h3>If this has helped you and saved your time please consider a help to plugin developer to develop new extraordinary plugin. So, Please click If Ad shown below :<div align="center"></div>
</th>
        </tr>
  ...
  <a href="http://www.Amazon.in/exec/obidos/redirect-home?tag=coup06-21&placement=home_multi.gif&site=amazon" target="_blank">
...
<iframe src='http://www.flipkart.com/affiliate/displayWidget?affrid=WRID-142944857109789452' frameborder=0 height=250 width=300></iframe>
<?php } ?>
</td></tr></table>
</div>
<?php }?>