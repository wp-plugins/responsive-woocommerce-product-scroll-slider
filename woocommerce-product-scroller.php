 ...
 * Author: Raju
 * Author URI: http://www.wpfreeplugin.com
 *
*/
...
<div class="wrap ms-toggle">
  ...
  <table width="50%" class="widefat">
        ...
        <tr>
          <th style="width: 100px;" colspan="2"><h3>If this has helped you and saved your time please consider a donation of only $2 via PayPal :<div align="center"><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="AFAW56ZM532RY">
<input type="image" src="<?php echo WOOPRODUCTSCROLLER_URI; ?>/images/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
</form></div>
</th>
        </tr>
